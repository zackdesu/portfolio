    ...
    <>
      {path === "/" ? (
        <a href={`${href}`}>
          <li
            className={
              "text-slate-800 dark:text-slate-200 p-3 active:text-cyan-500 dark:hover:text-cyan-500 font-semibold relative group text-base"
            }
            onClick={() => {
...
export default function Navbar() {
  return (
    <header
      className={`bg-neutral-100 dark:bg-neutral-900 border-b-2 border-zinc-200 dark:border-zinc-800 text-slate-950 w-full flex items-center max-md:justify-between max-md:px-8 md:justify-around py-5 dark:text-slate-50 sticky z-[99999999] top-0`}
    >
